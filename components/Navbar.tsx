...
const Navbar = () => {
  ...
  return (
    <section
      className={`fixed bottom-0 left-0 flex w-full z-50 justify-between px-4 py-2 shadow-lg ${pathName === "/add-post" || pathName === "/setting" || pathName === "/opening" || pathName === "/login" ? "hidden" : ""} ${
